				...
				<div class="col-md-6 col-md-offset-3 fondo_blanco">
					<form class="" action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group {{ $errors->has('password_confirmation')?'has-error':'' }}">
							<label class="control-label" for="password_confirmation">Verificar: <span class="span_rojo">*</span></label>
							<input id="password_confirmation" class="form-control" type="password" name="password_confirmation" required>
						</div>

						<div class="form-group {{ $errors->has('perfil_id')?'has-error':'' }}">
							<label class="control-label" for="perfil_id">Perfil: <span class="span_rojo">*</span></label>
						...
						<div class="form-group {{ $errors->has('perfil_id')?'has-error':'' }}">
							<label class="control-label" for="status">Estatus: <span class="span_rojo">*</span></label>
