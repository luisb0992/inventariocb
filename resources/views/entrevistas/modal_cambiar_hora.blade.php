<div class="modal fade" tabindex="-1" role="dialog" id="cambiar_hora">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
				<div class="">
					<buttton class="close" type="button" data-dismiss="modal">&times;</buttton>
					<div class="label-primary text-center padding_1em">
						<h3><i class="fa fa-edit"></i> Actualizar Hora</h3>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-sm-12">
								<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
								<input type="text" id="hora" class="form-control timepicker">
							</div>
						</div>
					</div>
				</div>
