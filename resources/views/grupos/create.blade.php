...
@section('breadcrumb')
	<ol class="breadcrumb">
	  ...
	  <li><a href="{{route('grupos.index')}}" title="Grupos"> Grupos </a></li>
				...
				<div class="col-sm-12 fondo_blanco">
					<form class="" action="{{ route('grupos.store') }}" method="POST">
						...
						<div class="form-group {{ $errors->has('clave_face')?'has-error':'' }} col-sm-4">
							...
							<input class="form-control" type="password" name="clave_face" placeholder="clave face..." required>
						</div>
						...
						<div class="form-group {{ $errors->has('clave_email')?'has-error':'' }} col-sm-4">
							...
							<input class="form-control" type="password" name="clave_email" required>
						</div>
						...
						<div class="form-group text-right">
							...
							<button class="btn btn-flat btn-primary" type="submit"><i class="fa fa-send"></i> Asignar</button>
						</div>
